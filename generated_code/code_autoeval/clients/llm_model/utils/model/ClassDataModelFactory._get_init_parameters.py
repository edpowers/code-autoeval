...
def test_mocked_class():
    ...
    assert result == [], f"Expected no parameters for the mocked class but got {result}"        pass

    result = ClassDataModelFactory._get_init_parameters(mock_class)
    assert result == [], f"Expected no parameters for the mocked class but got {result}"